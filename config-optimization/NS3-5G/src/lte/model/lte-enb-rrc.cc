...
LteEnbRrc::LteEnbRrc ()
  : m_x2SapProvider (0),
    ...
    m_firstSibTime (100), // Changed Here
...
LteEnbRrc::GetTypeId (void)
{
  ...
  static TypeId tid = TypeId ("ns3::LteEnbRrc")
    ...
    .AddAttribute ("SystemInformationPeriodicity",
                   ...
                   TimeValue (MilliSeconds (1000)), // TODO Changed here
   ...
   .AddAttribute ("CrtPeriod",
       ...
       IntegerValue(500000), // TODO Changed here
...
LteEnbRrc::ConfigureCell (std::map<uint8_t, Ptr<ComponentCarrierEnb>> ccPhyConf)
{
   ...
   */
  Simulator::Schedule (MilliSeconds (100), &LteEnbRrc::SendSystemInformation, this); // Changed here
  m_imsiCellSinrMap.clear();
  m_firstReport = true;
  m_configured = true;
